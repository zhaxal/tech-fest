            ...
            description={
              <>
                ...
                <p>
                  ...
                  легендарного Аркадия Цареградцева — амбассадора и супербосса
                  соревнований — лучшие джимханисты страны продемонстрируют
                  виртуозное владение машиной. Скорость, точность, дым из-под
                  колёс и филигранные манёвры в ограниченном пространстве — вот
                  что такое джимхана.
                </p>
              </>
            }
